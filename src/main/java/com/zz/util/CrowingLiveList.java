...
public class CrowingLiveList {
    ...
    public static List<LiveShow> allLive = new ArrayList<>();

    public void crowingHuya() throws Exception {
        ...
        allLive.addAll(liveShows);

    }


    public void crowingLongZhu() throws Exception {
    ...
    public void crowingZanQi() throws Exception {
    ...
    public void crowingQuanMin() throws Exception {
